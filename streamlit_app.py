...
NFL_4S = {
    "6.0": {
        ...
        # Area 3.0~4.0 區間針對 AR 2.45 進行校準 (目標 1.2)
        # Area 3.0: AR2.0=1.60, AR3.0=1.00 -> AR2.45 ~= 1.33
        # Area 4.0: AR2.0=1.10, AR3.0=0.80 -> AR2.45 ~= 0.96
        # Area 3.19 插值 -> ~1.24 (符合要求)
        "ar2.0": [3.50, 1.85, 1.60, 1.10, 0.85, 0.60], 
        "ar3.0": [3.00, 1.45, 1.00, 0.80, 0.60, 0.45], 
        "ar4.0": [2.60, 1.25, 0.80, 0.60, 0.45, 0.30]
    },
    "8.0": {
